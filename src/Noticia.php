...
final class Noticia {
    ...
    public function listarDetalhes():array {
      ...
      public function listarPorCategoria():array {
        $sql = "SELECT noticias.id, noticias.titulo, noticias.data, noticias.texto, noticias.resumo,
    ...
    public function busca():array {
        $sql = "SELECT titulo, data, resumo, id FROM noticias
            WHERE titulo LIKE :termo OR texto LIKE :termo OR resumo LIKE :termo
            ORDER BY data DESC";
